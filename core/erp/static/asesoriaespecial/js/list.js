        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="/erp/asesoriaespecial/update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/erp/asesoriaespecial/delete/' + row.id + '/" type="button" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a> ';
...
$(function () {
    ...
    $('#data tbody').on('click', 'a[rel="edit"]', function () {
        ...
        modal_title.find("span").html("Detalles de Asesoria especial");
        ...
        $('#myModalAsesoriaEspecial').modal('show');
    });



    $('#myModalAsesoriaEspecial').on('shown.bs.modal', function () {
        // $('form')[0].reset();
    });
