...
from core.erp.models import Accidente, Actividad, Capacitacion, Visita, Asesoria, AsesoriaEspecial, Empresa, Funcionario


class DashboardClienteView(LoginRequiredMixin, TemplateView):
    template_name = 'report/dashboardcliente.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search_report':
                ...
                data.append({'name': 'Visita', 'data': self.get_funcionario_v()})
                data.append(
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Panel de Rendimiento'
